...
const sqlInsertConfig = 'INSERT INTO config(collection_name, wallet_strings, secondary, admin_role_id, admin_role_name, registered_role_id, registered_role_name, optin_asa_id, optin_tx_timeout) VALUES("", "", "", "", "", "", "", "", 0);';
